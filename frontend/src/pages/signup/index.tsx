...
const index = () => {
    ...
    const { values, errors, touched, handleBlur, handleChange, handleSubmit, setFieldTouched, resetForm } = useFormik({
        ...
        onSubmit: async (value, action) => {
            ...
            let userPhoneNo = value.phoneNo
            let dob = value.dob
            let userType = value.usertype
            let userEmail = value.email.toLowerCase();
            let userPassword = value.password;

            // console.log(userFirstname, userLastname, userPhoneNo, dob, userType, userEmail, userPassword, '......')
            setspinner(true)
            try {
                const payload = {
                ...
                const response = await axios.post(`${process.env.API_BASE_URL}/auth/register`, payload);
                        ...
                        <div className="mt-10">
                            ...
                            <div className="mt-6">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <FormLabel className="mt-5">Phone No*</FormLabel>
                                    ...
                                    <FormInput
                                        ...
                                        onBlur={handleBlur}
                                    />
                                    {errors.phoneNo && touched.phoneNo ? (<p className="text-red-500" >{errors.phoneNo} </p>) : null}


                                    <FormLabel className="mt-5">Date of Birth*</FormLabel>
                                    ...
                                    {errors.dob && touched.dob ? (<p className="text-red-500" >{errors.dob} </p>) : null}
                ...
                >
                    <div className="sticky top-0 z-10 flex-col justify-center hidden h-screen ml-16 lg:flex xl:ml-28 2xl:ml-36">
                        <div className="leading-[1.4] text-[2.6rem] xl:text-5xl font-medium xl:leading-[1.2] text-white">
                            Shopify App Internal Dashboard!
                        </div>
