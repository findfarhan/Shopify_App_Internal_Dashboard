...
const imageAssets = ['/src/assets/images/users/user1-50x50.jpg',"/src/assets/images/users/user2-50x50.jpg"]// glob.sync('/src/assets/images/users/*.{jpg,jpeg,png,svg}');
    ...
    const users: Array<User> = [
      {
        ...
        photo: "/src/assets/images/users/user1-50x50.jpg",
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user2-50x50.jpg"],
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user3-50x50.jpg"],
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user4-50x50.jpg"],
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user5-50x50.jpg"],
      ...
      },
      {
        ...
        photo: "./src/assets/images/users/user6-50x50.jpg",
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user7-50x50.jpg"],
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user8-50x50.jpg"],
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user9-50x50.jpg"],
      ...
      },
      {
        ...
        photo: imageAssets["/src/assets/images/users/user10-50x50.jpg"],
