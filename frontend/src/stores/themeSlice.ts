...
export const getTheme = () => {
  // const theme = search === undefined ?  ((typeof window !== 'undefined')?localStorage.getItem("theme"):'default') : search;
  // const theme = 'default'
...
const initialState: ThemeState = {
  value:
    (typeof window !== 'undefined') ? (localStorage.getItem("theme") === null ? themes[0].name : getTheme().name) : 'echo',
};
